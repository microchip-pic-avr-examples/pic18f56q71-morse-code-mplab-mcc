...
void morseRx_stateMachine(void)
{
    switch (rxState)
    {
        case MORSE_RX_POS:
        {
            ...
            MorseCharacter pos = morseRx_convertToMorseCharacter(TU16A_CaptureValueRead());
        ...
        case MORSE_RX_NEG:
        {
            ...
            MorseCharacter neg;
            neg = morseRx_convertToMorseCharacter(TU16B_CaptureValueRead());
